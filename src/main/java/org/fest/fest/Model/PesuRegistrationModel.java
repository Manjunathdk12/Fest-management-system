...
public class PesuRegistrationModel {
    ...
    public void saveOrgToDb(String email, String password, String userName, String department){
        ...
        query = "INSERT INTO pesuManagement (org_id, name, department) VALUES (?, ?, ?);";
